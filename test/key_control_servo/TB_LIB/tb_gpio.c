...
void dj_io_set(u8 index, u8 level) {
	switch(index) {
		case 0:gpioB_pin_set(15, level);break;
		case 1:gpioA_pin_set(8, level);break;
		case 2:gpioB_pin_set(5, level);break;
		case 3:gpioB_pin_set(4, level);break;
		case 4:gpioB_pin_set(3, level);break;
		case 5:gpioA_pin_set(15, level);break;
		default:break;
	}
}
