...
#define beep_on() 	{gpioB_pin_set(4, 0);}
#define beep_off() 	{gpioB_pin_set(4, 1);}

#define nled_on()	{gpioB_pin_set(3, 0);}
#define nled_off()	{gpioB_pin_set(3, 1);}

#define mkey_read()	    GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_0)
